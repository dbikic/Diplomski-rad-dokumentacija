...
\degreesubject{Diplomski sveu\v{c}ili\v{s}ni studij ra\v{c}unarstva} % upisati odgovarajuci naziv studija
...
\include{01_Uvod}   
\include{02_Specifikacija_rada}   
\include{03_NFC} 
\include{04_BLE}   
\include{05_Izvedba}
\include{06_Android_aplikacija}
\include{07_Internetska_aplikacija} 
\include{08_Usporedba} 
\include{09_Zakljucak} 
...
\include{sazetak}  % ovo je ime Bibtex datoteke koju korisnik kreira
