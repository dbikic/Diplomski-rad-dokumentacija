...
\begin{figure}[!htbp]
	\begin{center}
 \includegraphics[height=6cm,keepaspectratio=true]{web_login}
...
\begin{figure}[!htbp]
	\begin{center}
 \includegraphics[height=5.5cm,keepaspectratio=true]{web_glavni}
...
\begin{figure}[!htbp]
	\begin{center}
 \includegraphics[height=12cm,keepaspectratio=true]{web_dodaj_popust}
...
\begin{figure}[!htbp]
	\begin{center}
 \includegraphics[height=3.5cm,keepaspectratio=true]{web_kodovi}
...
\begin{figure}[!htbp]
	\begin{center}
 \includegraphics[height=11cm,keepaspectratio=true]{web_json}
 \caption{Aktivirani kodovi popusta}
 \label{fig:web_json}
	\end{center}
\end{figure}
